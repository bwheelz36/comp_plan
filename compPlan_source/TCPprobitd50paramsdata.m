function TCPprobitparams=TCPprobitparamsdata(basedirectory,structurename)
...
filename=strcat(basedirectory,'\TCPprobitparams.txt');
fid = fopen(filename) ;
...
if (found==1);
    TCPprobitparams.structure=structure(i);
    TCPprobitparams.d50=d50(i);
    TCPprobitparams.g50=g50(i);
     TCPprobitparams.ref=ref(i);
end
end
