function tcpPossionparams=TCPpossiond50paramsdata(basedirectory,structurename)
...
filename=strcat(basedirectory,'\TCPpossiond50params.txt');
fid = fopen(filename) ;
...
if (found==1)
    tcpPossionparams.structure=structure(i);
    tcpPossionparams.d50=d50(i);
    tcpPossionparams.g50=g50(i);
     tcpPossionparams.ref=ref(i);
end
end
