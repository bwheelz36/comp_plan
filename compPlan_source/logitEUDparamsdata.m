function logitEUDparams=logitEUDparamsdata(basedirectory,structurename)
...
filename=strcat(basedirectory,'\logitEUDparams.txt');
fid = fopen(filename) ;
...
if (found==1);
    logitEUDparams.structure=structure(i);
    logitEUDparams.d50=d50(i);
    logitEUDparams.g50=g50(i);
     logitEUDparams.ref=ref(i);
end
end
